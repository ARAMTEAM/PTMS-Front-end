      ...
      <Layout>
        <Header :style="{background: '#515A6E'}">
          <div>
            ...
            <div class="portraitContain" >
              <Avatar class="Portraits" size="large" ><p class="UncatchText" >{{Info.teacherName}}</p></Avatar>
              <!-- 头像菜单 -->
              <div class="PMenu">
                  <Card :title="'教师:'+Info.teacherName" icon="ios-options" :padding="0" shadow style="width: 200px;">
                      <CellGroup>
                          <Cell :title="Info.teacherRank" label="欢迎来到项目实训系统" />
                          <Cell title="我的中心" to="/"/>
                          <Cell title="退出登录" to="/logout?role=teacher"></Cell>
                      </CellGroup>
                  </Card>
              </div>
            </div>    
        ...
        <Layout>
          ...
          >
            ...
            >
              <MenuItem name="1" to="/teacher/home">
              ...
              <Submenu name="2">
                ...
                <MenuItem name="2-1" to="/teacher/practice">
                  <span>项目申请</span>
                </MenuItem>
              </Submenu>
              <Submenu name="3">
