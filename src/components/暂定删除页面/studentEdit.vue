<template>
  <div class="Container" >
      ...
      <div class="form">
          ...
          <Form ref="studentForm" :model="formItem" :label-width="100" :rules="ruleInline" >
              <FormItem label="学生姓名" prop="name">
                  <Input v-model="formItem.name" placeholder="请输入学生名称"></Input>
              </FormItem>

              <FormItem label="学生密码" prop="passwd">
                <Input type="password" password v-model="formItem.passwd" placeholder="请输入密码"></Input>
              </FormItem>

              <FormItem label="学生电话" prop="telephone">
                <Input v-model="formItem.telephone" placeholder="请输入教师电话"></Input>
              </FormItem>
              <FormItem label="学生邮箱" prop="email">
                <Input v-model="formItem.email" placeholder="请输入教师邮箱"></Input>
              </FormItem>
            
              <FormItem label="学生班级" prop="class">
                <Input v-model="formItem.class" placeholder="请输入教师邮箱"></Input>
              </FormItem>
